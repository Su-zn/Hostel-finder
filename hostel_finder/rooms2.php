...
<body>
    ...
    <section class="room">
        <img src="images/singleroom.jpg" alt="Single-seater Room">
        <div class="room-details">
            <h2>Single-Seater Room</h2>
            <p>Perfect for single Student</p>
            <ul>
                <li>1 Seater</li>
                <li>Bathroom</li>
                <li>Free Wi-Fi</li>
    ...
    <!-- Add four-seater room section -->
    <section class="room">
        <img src="images/fourrooms.jpg" alt="Four-Seater Room">
        <div class="room-details">
            <h2>Four-Seater Room</h2>
